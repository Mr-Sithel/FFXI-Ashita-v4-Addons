...
local KeyItems = {
    ...
    BastokEco           = { Id = 473, Name = "Indigested Ore" },
    SandyEco            = { Id = 472, Name = "Indigested Stalagmite" },
    WindyEco            = { Id = 474, Name = "Indigested Meat" },    
    ...
    SG                  = { Id = 621, Name = "Rivernewort" },
    SOL                 = { Id = 622, Name = "Tavnazian Cookbook" },
    UG                  = { Id = 720, Name = "Monarch Linn Patrol Permit" },
}
...
local Weeklies = T{
    ...
    {
        Level = '75',
        Name = 'Uninvited Guests (Justinius)',
        KeyItem = KeyItems.UG,
        Cooldown = 120 * 3600,
    },
    {
    ...
    },
    {
        ...
        KeyItem = KeyItems.BastokEco,
        Cooldown = 504 * 3600,
    },
    {
        Level = '20',
        Name = 'Eco-Warrior (San d\'Oria)',
        KeyItem = KeyItems.SandyEco,
        Cooldown = 504 * 3600,
    },
    {
        Level = '20',
        Name = 'Eco-Warrior (Windurst)',
        KeyItem = KeyItems.WindyEco,
        Cooldown = 504 * 3600,
    },
    {
        Level = '20',
        Name = 'Spice Gals (Rouva)',
        KeyItem = KeyItems.SG,
        Cooldown = 120 * 3600,
    },
    {
        Level = '20',
        Name = 'Secrets of Ovens Lost (Jonette)',
        KeyItem = KeyItems.SOL,
        Cooldown = 120 * 3600,
    },    
}
