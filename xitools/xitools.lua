...
local dynamis = require('dynamis')
local regions = require('regions')
--local lockstyle = require('lockstyle')
...
local defaultOptions = T{
    ...
    tools = T{
        ...
        summon = summon.DefaultSettings,
        dynamis = dynamis.DefaultSettings,
        regions = regions.DefaultSettings,
        --lockstyle = lockstyle.DefaultSettings,
    },
}
